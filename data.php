...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card">
        <!-- <div class="header"> <h2> DATA MAINTENANCE/TROUBLE/REQUEST IT TODAY </h2>
        </div> -->
        <div class="body">
                ...
                <table
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                            <?php 
                                            if ($data['noteperbaikan'] == null) {
                                                echo "~";
                                            } else {
                                                echo $data['noteperbaikan']; 
                            ...
                            <td>
                                <?php echo $data['tglselesai'];echo" ["; echo $data['jamselesai']; echo"]";?>
                            </td>
