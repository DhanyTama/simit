...
<?php } ?>
                ...
                <section class="content">
                        ...
                        <div class="col-xs-12">
                            <div class="panel">
                                ...
                                <div class="panel-body table-responsive">
                                    ...
                                    <?php
                    $query1="select * from pengunjung order by id desc limit 100";
                  ...
                  <thead>
                    ...
                    <td><a href="edit-anggotax.php?hal=edit&kd=<?php echo $data['id'];?>"><span class="fa fa-user"></span> <?php echo $data['nama']; ?></a></td>
              ...
              ?>
                ...
                <div class="text-right" style="margin-top: 10px;">
                 <a href="anggota.php" class="btn btn-sm btn-info">Refresh <i class="fa fa-refresh"></i></a>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </div>
