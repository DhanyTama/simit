...
<?php } ?>
				...
				<form action="cetakpdf.php" method="post" target="_blank">
                                    <?php
                   
                    
	              
	               $query1="SELECT tgllapor, nama, jnskendala, kendala, petugas, tglperbaikan, jamperbaikan, status
							FROM pengunjung
                    ...
                    ?>
					<input name="tahun" type="hidden" value="<?php echo $thn; ?>">
					<input name="bulan" type="hidden" value="<?php echo $bln; ?>">
					<input name="depart" type="hidden" value="<?php echo $departemen; ?>">
                  <table id="example" class="table table-hover table-bordered">
                  <thead>
				  <tr>
				  	<td colspan="8">Departemen &nbsp; : &nbsp;[<?php echo $departemen; ?>]</td>
              ...
              ?>
                ...
                <div class="text-right" style="margin-top: 10px;">
                 <a href="laporan_grafik.php" class="btn btn-sm btn-info">Kembali </i></a> <a href="cetakpdf.php" target="_blank"><button type="submit" class="btn-default">Cetak PDF </button></a>
				</form>
                </div>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
